...
namespace TechJobsOO.Tests
{
	public class TestTask3
	{
        ...
        {
            TechJobs testJob1 = new TechJobs();
            TechJobs testJob2 = new TechJobs();
        ...
        {
            //setup
            TechJobs testJob1 = new TechJobs("Product tester", new Employer("ACME"), new Location("Desert"), new PositionType("Quality control"), new CoreCompetency("Persistence"));
            TechJobs testJob2 = new TechJobs("Product tester", new Employer("ACME"), new Location("Desert"), new PositionType("Quality control"), new CoreCompetency("Persistence"));
